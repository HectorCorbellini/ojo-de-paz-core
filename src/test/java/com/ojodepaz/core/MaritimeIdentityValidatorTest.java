...
public class MaritimeIdentityValidatorTest {
    ...
    void testNullDeviceId() {
        MaritimeIdentityValidator.GPSMetadata gps = new MaritimeIdentityValidator.GPSMetadata(10.0, -75.0,
                TEST_TIME.getEpochSecond());
    ...
    void testValidGPSCoordinates() {
        MaritimeIdentityValidator.GPSMetadata gps = new MaritimeIdentityValidator.GPSMetadata(10.423456, -75.523456,
                TEST_TIME.getEpochSecond());
    ...
    void testInvalidLatitude() {
        MaritimeIdentityValidator.GPSMetadata gps = new MaritimeIdentityValidator.GPSMetadata(20.0, -75.0,
                TEST_TIME.getEpochSecond());
    ...
    void testInvalidLongitude() {
        MaritimeIdentityValidator.GPSMetadata gps = new MaritimeIdentityValidator.GPSMetadata(10.0, -50.0,
                TEST_TIME.getEpochSecond());
        assertFalse(validator.validateGPSIntegrity(gps));
    }
    ...
    void testBoundaryCoordinates() {
        MaritimeIdentityValidator.GPSMetadata gpsNorth = new MaritimeIdentityValidator.GPSMetadata(13.0, -75.0,
                TEST_TIME.getEpochSecond());
        MaritimeIdentityValidator.GPSMetadata gpsSouth = new MaritimeIdentityValidator.GPSMetadata(-4.0, -75.0,
                TEST_TIME.getEpochSecond());
        MaritimeIdentityValidator.GPSMetadata gpsWest = new MaritimeIdentityValidator.GPSMetadata(10.0, -82.0,
                TEST_TIME.getEpochSecond());
        MaritimeIdentityValidator.GPSMetadata gpsEast = new MaritimeIdentityValidator.GPSMetadata(10.0, -66.0,
                TEST_TIME.getEpochSecond());
    ...
    void testJustOutsideBoundary() {
        MaritimeIdentityValidator.GPSMetadata gpsNorth = new MaritimeIdentityValidator.GPSMetadata(13.01, -75.0,
                TEST_TIME.getEpochSecond());
        MaritimeIdentityValidator.GPSMetadata gpsSouth = new MaritimeIdentityValidator.GPSMetadata(-4.01, -75.0,
                TEST_TIME.getEpochSecond());
        MaritimeIdentityValidator.GPSMetadata gpsWest = new MaritimeIdentityValidator.GPSMetadata(10.0, -82.01,
                TEST_TIME.getEpochSecond());
        MaritimeIdentityValidator.GPSMetadata gpsEast = new MaritimeIdentityValidator.GPSMetadata(10.0, -65.99,
                TEST_TIME.getEpochSecond());
